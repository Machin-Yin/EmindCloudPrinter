...
#                     self.cups.addPrinter("helloPrinter",ppdname="/home/wufeiyun/Lenovo1.ppd",device=uri,info=info,location=location)
...
#                     self.cups.addPrinter(name,ppd,device=uri,info=info, location=name)
